...
class data extends db { //inheritance
    ...
    function userLogin($t1, $t2) {
        ...
        if ($result > 0) {
            ...
            header("location: studentform.php?msg=Invalid Credentials");
        }
    ...
    function addbook($bookpic, $bookname, $bookdetail, $bookaudor, $bookpub, $courses, $bookprice, $bookquantity) {
       ...
       $q="INSERT INTO book (id,bookpic,bookname, bookdetail, bookaudor, bookpub, courses, bookprice,bookquantity,bookava,bookrent)VALUES('','$bookpic', '$bookname', '$bookdetail', '$bookaudor', '$bookpub', '$courses', '$bookprice', '$bookquantity','$bookquantity',0)";
    ...
    function getissuebook($userloginid) {
        ...
        if($issuereturn<$getdate){
            ...
            // $q="UPDATE issuebook SET fine ='$newfine' WHERE id= '$issueid'";
