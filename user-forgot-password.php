...
$newpassword=md5($_POST['newpassword']);
  $sql ="SELECT EmailId FROM userdata WHERE EmailId=:email and MobileNumber=:mobile";
...
if($query -> rowCount() > 0)
{
$con="update userdata set Password=:newpassword where EmailId=:email and MobileNumber=:mobile";
$chngpwd1 = $this->connection($con);
